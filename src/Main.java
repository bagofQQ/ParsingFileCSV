...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<BankAccount> movementList = loadMovementListFromFile();
    ...
    private static ArrayList<BankAccount> loadMovementListFromFile() {
    ...
    private static BigDecimal getExpenseSum(ArrayList<BankAccount> movementList) {
    ...
    private static BigDecimal getIncomeSum(ArrayList<BankAccount> movementList) {
    ...
    private static HashMap<String, BigDecimal> getMapNameExpense(ArrayList<BankAccount> movementList) {
        ...
        movementList.stream()
                .collect(Collectors.toMap(BankAccount::getCompanyName
                        , BankAccount::getMoneySpending
